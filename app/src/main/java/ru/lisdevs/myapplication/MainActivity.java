...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    private void setUpPreferences(){
        int imageId = PreferenceManager.getDefaultSharedPreferences(this).getInt(MyUtils.PREF_IMAGE_ID, R.drawable.dice3);
    ...
    public void lockSpiner(View v){
        ...
        imageView.animate();
        Toast.makeText(this, "Спиннер заблокирован", Toast.LENGTH_SHORT).show();
    }
